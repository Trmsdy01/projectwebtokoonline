...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "origin=48&destination=".$distrik."&weight=".$berat."&courier=".$ekspedisi,
  CURLOPT_HTTPHEADER => array(
    "content-type: application/x-www-form-urlencoded",
    "key: d403bd43439c98cd1b899b9b4798ac59"
  ),
));
...
if ($err) {
  ...
  echo "<option value=''>Choose Packet</option>";

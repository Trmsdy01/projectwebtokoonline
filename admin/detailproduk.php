...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <img src="../admin/fotoproduk/<?php echo $value["nama_produk_foto"]?>" alt="" class="img-responsive"><br>
        <a href="index.php?halaman=hapusfotoproduk&idfoto=<?php echo $value["id_produk_foto"]?>&idproduk=<?php echo $id_produk?>" class="btn btn-danger btn-sm">DELETE</a>
    </div>
    <?php endforeach?>
</div>
...
<form method="post" enctype="multipart/form-data">
    ...
    <button class="btn btn-primary" name="simpan" value="simpan">SAVE</button>
</form>
...
if (isset($_POST["simpan"]))
{
    ...
    echo "<script>alert('Product photo data has been successfully saved');</script>";
